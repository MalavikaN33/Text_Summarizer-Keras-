...
from glove_loader import load_glove, GLOVE_EMBEDDING_SIZE
import numpy as np
import os
...
class Seq2SeqSummarizer(object):
    """
    Creates a sequence to sequence text summarization model using keras LSTMs in an encoder-decoder network. The configurable parameters for this network are passed from the fit_text function in 
    """
    model_name = 'seq2seq'
